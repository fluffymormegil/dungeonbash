 ...
 *
 * This file is derived from Daniel J. Bernstein's salsa20-ref.c, reformatted
 * according to the dungeonbash coding standards. This revamped version of the
 * file is placed in the public domain just like the original.
 */
